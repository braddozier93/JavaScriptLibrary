//// Challenge: using Array.prototype.map(), console.log the first and last
// names of each president from the given 'presidents' array.

//map can return data but foreach does not
const presidents = [
...
/*let fn = () => {
    ...
    presidents.forEach(president => {
        newlist.map({president([first],[last])
        })
    }
    return newMap;
};
