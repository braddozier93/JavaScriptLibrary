// Challenge: Using the Array.prototype.reduce() method, find the total number of years
// that presidents have lived. You will need to implement logic that checks if the 
//president is still currently living. If the president IS still currently living, 
//use the current year of 2019.
