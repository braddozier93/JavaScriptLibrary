// Challenge: using the Array.prototype.filter() method, filter through the 
//presidents array and console.log only the presidents who were born in the 1900's.
...
const newArray = presidents.filter(president => president.year >= 1900 && president.year < 2000);
console.log(newArray);

// creates a new array based on criteria we create with our callback function
