//Challenge: using Array.protoype.sort(), sort the presidents by birth year, oldest to youngest.
//you will need to implement logic that check to see the year each president was born
const presidents = [
...
//method sorts an array based on our criteria, but it does not create a new array
//concise body answer--dont have to create new array, because sort just rearranges our current one
presidents.sort((a, b) => a.year - b.year);
